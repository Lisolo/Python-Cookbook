...
"""
The first argument to TemporaryFile() is the file mode, 
which is usually w+t for text and w+b for binary. 
This mode simultaneously supports reading and writing, 
which is useful here since closing the file to change modes would actually destroy it. 
...
If you want to relax this constraint, use NamedTemporaryFile() instead. For example:
...
If you don’t want this, supply a delete=False keyword argument. For example:
...
The TemporaryFile(), NamedTemporaryFile(), 
and TemporaryDirectory() functions are probably the most convenient way to work with temporary files and directories, 
...
"""
All of the temporary-file-related functions allow you to override this directory as well as 
the naming conventions using the prefix, suffix, and dir keyword arguments. For example:

>>> f = NamedTemporaryFile(prefix='mytemp', suffix='.txt', dir='/tmp')
>>> f.name
'/tmp/mytemp_yyk6__z.txt'
>>>
"""
