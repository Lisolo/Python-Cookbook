...
assertions about how they were used in the test (e.g., assertions about being called with certain parameters, access to selected attributes, etc.).
...
By default, values are replaced with MagicMock instances. For example:
...
They record information about usage and allow you to make assertions. For example:
...
that returns a BytesIO() containing sample data as a substitute.
