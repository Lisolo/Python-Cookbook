...
If you simply want to time your whole program, 
it’s usually easy enough to use something like the Unix time command. For example:
...
For selected profiling of functions, a short decorator can be useful. For example:
"""
...
...
>>> countdown(10000000)
__main__.countdown : 0.7706169620000765
>>>
"""
...
...             n -= 1
...
counting : 1.4410987090000162
>>>
"""

"""
For studying the performance of small code fragments, 
the timeit module can be useful. For example:
...
"""
Last, but not least, if you’re going to perform detailed timing analysis, 
make sure to read the documentation for the time, timeit, and other associated modules, 
so that you have an understanding of important platform-related differences and other pitfalls.
