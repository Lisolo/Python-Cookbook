...
"""
import sys
def main(out=sys.strderr, verbosity=2):
    loader = unittest.TestLoader()
    suite = loader.loadTestsFormModule(sys.modules[__name__])
...
The interesting thing about this recipe is not so much the task of getting test results redirected to a file, 
but the fact that doing so exposes some notable inner workings of the unittest module.
...
If you want something more fine-grained, 
...
Although this recipe only consists of a few lines of code, 
it gives a hint as to how you might further customize the unittest framework. 
